...
class Bishop extends Component {
    ...
    render() {
        ...
        return <div className="bishop" id={this.props.id}>
            <svg
                ...
                strokeOpacity:1}}>
                    ...
                    <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 22.5,15.5 L 22.5,20.5 M 20,18 L 25,18" style={{fill:this.props.color, stroke:this.props.outline, strokeLinejoin:"miter"}} />
                </g>
            </svg>
        </div>
            ;
